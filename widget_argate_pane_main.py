...
class WIDGET_ARGATE_PANE_MAIN(QWidget):
    ...
    def __init__(self, app_data):
        ...
        #self.appData.prefillComDataTable()
    ...
    def prefillComDataTable(self):
        ...
        str = GF.weekdayIdToString(self.appData.CD.weekday)
        ...
        rec.append(UDT_TABLE_CELL(current_row, 0, dat))
        dat = UDT_TABLE_CELL_DATA(ENM_TABLE_DATA_TYPE.STRING, GF.isWeekendToString(self.appData.CD.isWeekend))
        dat.textAlignment = Qt.AlignRight | Qt.AlignVCenter
        rec.append(UDT_TABLE_CELL(current_row, 1, dat))
        ...
        current_row += 1
        rec = UDT_TABLE_RECORD()
        dat = UDT_TABLE_CELL_DATA(ENM_TABLE_DATA_TYPE.STRING, "Ночь")
        rec.append(UDT_TABLE_CELL(current_row, 0, dat))
    ...
    def msgprc_OnTickUpdate(self):
        ...
        self.appData.model_ComDataTable.body[1][1].data.value = GF.weekdayIdToString(self.appData.CD.weekday)
        self.appData.model_ComDataTable.body[2][1].data.value = GF.isWeekendToString(self.appData.CD.isWeekend)

        if self.appData.CD.isWeekend:
            self.appData.model_ComDataTable.body[1][1].data.textColor = QColor(255, 0, 0)
            self.appData.model_ComDataTable.body[2][1].data.textColor = QColor(255, 0, 0)
        else:
            self.appData.model_ComDataTable.body[1][1].data.textColor = QColor(0, 0, 0)
            self.appData.model_ComDataTable.body[2][1].data.textColor = QColor(0, 0, 0)

        self.appData.model_ComDataTable.body[3][1].data.value = self.appData.CD.time
        self.appData.model_ComDataTable.body[4][1].data.value = self.appData.CD.shiftPlanCaption
        self.appData.model_ComDataTable.body[5][1].data.value = self.appData.CD.shiftCaption
        self.appData.model_ComDataTable.body[6][1].data.value = self.appData.CD.curShiftBTime
        self.appData.model_ComDataTable.body[7][1].data.value = self.appData.CD.curShiftETime
        self.appData.model_ComDataTable.body[8][1].data.value = GF.yes_no_ToString(self.appData.CD.isNight)
        self.appData.model_ComDataTable.body[9][1].data.value = self.appData.CD.scheduledBreakCaption
        self.appData.model_ComDataTable.body[10][1].data.value = self.appData.CD.curScheduledBreakBTime
        self.appData.model_ComDataTable.body[11][1].data.value = self.appData.CD.curScheduledBreakETime
        self.appData.model_ComDataTable.body[12][1].data.value = GF.yes_no_ToString(self.appData.CD.isDinner)
        self.appData.model_ComDataTable.body[13][1].data.value = GF.yes_no_ToString(self.appData.CD.isWorkingShift)
        #if self.appData.CD.isWorkingShift:
        #    self.appData.model_ComDataTable.body[14][1].data.value = GF.yes_no_ToString(self.appData.CD.isScheduledBreak)
        #else:
        #    self.appData.model_ComDataTable.body[14][1].data.value = "--"
        self.appData.model_ComDataTable.body[14][1].data.value = GF.yes_no_ToString(self.appData.CD.isScheduledBreak)
        self.appData.model_ComDataTable.body[15][1].data.value = GF.yes_no_ToString(self.appData.CD.isHoliday)
